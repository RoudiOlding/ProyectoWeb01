    ...
    const handleOnBusqueda = () => {
        if (clave !== '' && (filtro1 || filtro2 || filtro3 || filtro4 || filtro5 )) {
            ...
            if (tipo !== ''){
                ...
                libro.qualification?.toLowerCase().includes(tipo.toLowerCase())
                );
            }
        ...
        function BusquedaAvanzada(librosFiltrados) {
            if (filtro1 == true) {
                librosFiltrados = librosFiltrados.filter((libro) => libro.title?.toLowerCase().includes(clave.toLowerCase())
                );
            } else if (filtro2 == true) {
                console.log("Ejecutando opción 2");
                librosFiltrados = librosFiltrados.filter((libro) => libro.author?.toLowerCase().includes(clave.toLowerCase())
                );
            } else if (filtro3 == true) {
                console.log("Ejecutando opción 3");
                librosFiltrados = librosFiltrados.filter((libro) => libro.language?.toLowerCase().includes(clave.toLowerCase())
                );
